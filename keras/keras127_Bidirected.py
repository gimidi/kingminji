...
(x_train, y_train), (x_test,y_test) = imdb.load_data(num_words=2000) #, test_split=0.2) # 가장 많이 쓰여진 단어 1000개
...
from keras.layers import Dense, LSTM, Embedding, Flatten, MaxPooling1D
from keras.layers import Bidirectional, Dropout, Conv1D
model = Sequential()
...
# imdb 검색해서 데이터 내용 확인
# word_size 전체데이터 부분 변경해서 최상값 확인
# groupby()의 사용법 숙지할것
'''
