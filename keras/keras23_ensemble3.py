'''
keras21_ensemble3
MSE 는 6.1234459280967706e-09
RMSE 는 7.825244998143362e-05
R2는  0.9999999998158362
함수형 구조 자체가 x1,x2(두개 input) y1(한개 output) 이래....
'''
...
model.fit([x1_train,x2_train],y1_train, epochs=120, batch_size=5,validation_split = 0.25)
