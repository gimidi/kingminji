...
dense1_5 = Dense(1200, activation='relu')(dense1_4)
dense1_6 = Dense(80, activation='relu')(dense1_5)  
dense1_7 = Dense(32, activation='relu')(dense1_6) 
...
model.fit(x_train,y_train, epochs=3000, batch_size=10, callbacks=[early_stopping]
