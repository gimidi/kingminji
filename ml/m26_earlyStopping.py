...
# XGB에만 있는 애들인거 같아
model = XGBRegressor(n_estimators=1000, learning_rate=0.1) # 나무의 개수는 결국 epo다
model.fit(x_train, y_train, verbose=True, eval_metric='rmse', eval_set=[(x_train,y_train),(x_test,y_test)]
        , early_stopping_rounds=20) # topping. Best iteration:  validation_0-rmse:0.57088       validation_1-rmse:2.36899
