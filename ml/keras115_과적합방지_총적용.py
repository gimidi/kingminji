...
loss: 0.0524 - acc: 0.9829 - val_loss: 1.1613 - val_acc: 0.7590 ............?
'''
'''
acc = 83 %
'''
...
# CNN
model = Sequential()
model.add(Conv2D(32, kernel_size=3, padding='same', input_shape=(32, 32, 3), activation='relu', kernel_regularizer=l1(0.001)))
...
model.add(BatchNormalization())
model.add(Activation('relu'))
model.add(MaxPooling2D(pool_size=(2,2), strides=2, padding='same', kernel_regularizer=l1(0.001)))
model.add(Dropout(0.2))
